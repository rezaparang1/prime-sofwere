...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20251102190242_primedb")]
            ...
            modelBuilder.Entity("BusinessEntity.Fund.Cash_Register_To_The_User", b =>
                {
                    b.HasOne("BusinessEntity.Fund.Fund", "Fund")
                        ...
                        .HasForeignKey("BusinessEntity.Fund.Cash_Register_To_The_User", "FundId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessEntity.Settings.User", "User")
                        .WithOne("CashRegister")
                        .HasForeignKey("BusinessEntity.Fund.Cash_Register_To_The_User", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
