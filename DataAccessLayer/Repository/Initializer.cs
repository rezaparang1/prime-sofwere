        ...
        public async Task SeedAsync()
        {
            ...
            else
            {
                _db.Add(new BusinessEntity.Settings.Access_Level
                {
                    ...
                    IsSalesInvoice = true,
                    IsSalesInvoiceR = true,
                    IsPurchaseInvoice = true,
                    IsPurchaseInvoiceR = true,
                    IsPurchaseRInvoice = true,
                    IsPurchaseRInvoiceR = true,
                    IsSalesRInvoice = true,
                    IsSalesRInvoiceR = true,
                    IsOerder = true,
                    IsOerderR = true,
                    IsDefinitionProduct = true,
                    IsKardexProductR = true,
                    IsPublicDiscount = true,
                    IsStoreroomProduct = true,
                    IsProductFailure = true,
                    IsProductFailureR = true,
                    IsInventoryProduct = true,
                    IsOrderPointR = true,
                    IsMonthlyProductR = true,
                    IsQuarterlyProductR = true,
                    IsViewingofOthers = true,
                    IsDefinitionPeople = true,
                    IsSMSDefinition = true,
                    IsSendSMS = true,
                    IsPeopleR = true,
                    IsSentMessagesR = true,
                    IsSMSLogR = true,
                    IsBankAccountDefinition = true,
                    IsFund = true,
                    IsDeliverytoUser = true,
                    IsShiftWork = true,
                    IsBankandFundInventory = true,
                    IsBasicData = true,
                    IsUser = true,
                    IsGroupUser = true,
                    IsBackup = true,
                    IsRecovery = true,
                    IsAccessLevelDefinition = true,
                    IsSystemlog = true,
                    IsDailySalesR = true,
                    IsBankDetailedR = true,
                    IsFundDetailedR = true,
                    IsCardTransactionR = true,
                    IsDetailedProductDiscountR = true,
                    IsSalesPeopleR = true,
                    IsPurchasePeopleR = true,
                    IsProductTransactionR = true,
                    IsCustomerDefinition = true,
                    IsCustomerReport = true,
                    IsCustomerLevelDefinition = true,
                    IsCustomerLevelReport = true,
                    IsWalletIncreaseandDecrease = true,
                    IsClubDiscountDefinition = true,
                    IsClubDiscountReport = true,
