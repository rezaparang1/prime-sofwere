...
namespace WinFormsApp1.class1.People
{
    public class Popele
    {
        ...
        public Popele()
        {
            _httpClient = new HttpClient { BaseAddress = new Uri("http://85.9.123.232:5000/api/People/Group_People/") };
        }
        ...
        //*******READ********
        public async Task<List<DTO.People.Group_People>?> GetAllAsync()
        {
            try
            {
        ...
        public async Task<DTO.People.Group_People?> GetByIdAsync(int id)
        {
            try
            {
                AddAuthorizationHeader();
        ...
        //*******CRUD********
        public async Task<string> AddAsync(DTO.People.Group_People aysnc)
        {
            try
            {
                AddAuthorizationHeader();
        ...
        public async Task<string> UpdateAsync(DTO.People.Group_People aysnc)
        {
            try
            {
                AddAuthorizationHeader();
