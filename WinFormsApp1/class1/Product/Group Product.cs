...
namespace WinFormsApp1.class1.Product
{
    public class Group_Product
    {
        ...
        {
            _httpClient = new HttpClient { BaseAddress = new Uri("https://localhost:7182/api/Product/Group_Product/") };
        }
        ...
        //*******READ********
        public async Task<List<DTO.Product.Group_Product>?> GetAll()
        {
            try
            {
        ...
        public async Task<DTO.Product.Group_Product?> GetById(int id)
        {
            try
            {
                AddAuthorizationHeader();
        ...
        //*******CRUD********
        public async Task<string> Add(DTO.Product.Group_Product aysnc)
        {
            try
            {
                AddAuthorizationHeader();
        ...
        public async Task<string> Update(DTO.Product.Group_Product aysnc)
        {
            try
            {
                AddAuthorizationHeader();
