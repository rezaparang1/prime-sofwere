...
namespace Prime_Software.Controllers.Peoduct
{
    ...
    public class Group_Product : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] BusinessEntity.Product.Group_Product async)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] BusinessEntity.Product.Group_Product async)
        {
            if (id != async.Id)
