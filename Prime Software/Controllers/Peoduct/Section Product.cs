...
namespace Prime_Software.Controllers.Peoduct
{
    ...
    public class Section_Product : ControllerBase
    {
        ...
        private readonly ISectionProductService _service;

        public Section_Product(
            ICurrentUserService currentUser,
            ISectionProductService service)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] BusinessEntity.Product.Section_Product async)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] BusinessEntity.Product.Section_Product async)
        {
            if (id != async.Id)
