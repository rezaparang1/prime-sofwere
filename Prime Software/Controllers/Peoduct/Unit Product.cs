...
namespace Prime_Software.Controllers.Peoduct
{
    ...
    public class Unit_Product : ControllerBase
    {
        ...
        private readonly IUnitProductService _service;

        public Unit_Product(
            ICurrentUserService currentUser,
            IUnitProductService service)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] BusinessEntity.Product.Unit_Product async)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] BusinessEntity.Product.Unit_Product async)
        {
            if (id != async.Id)
